				...
				>
					...
					<div className="relative z-10 flex min-h-0 flex-auto flex-col">
						{/* Transition de page façon mobile : fondu + légère montée à chaque
						    changement de route. Pas d'AnimatePresence/exit (risque de
						    double-montage et de saut de hauteur) ; le wrapper reprend
						    exactement la chaîne flex pour garder une hauteur définie. */}
						<motion.div
							key={pathname}
