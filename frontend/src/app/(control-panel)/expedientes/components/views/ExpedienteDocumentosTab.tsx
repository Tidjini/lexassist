...
type ExpedienteDocumentosTabProps = {
	dossierId: number;
	clienteId: number;
	clienteLabel: string;
};

function ExpedienteDocumentosTab({ dossierId, clienteId, clienteLabel }: ExpedienteDocumentosTabProps) {
	...
	const { data, isLoading } = useDocumentos({ dossier: dossierId, page: paginationModel.page + 1 });
...
export default ExpedienteDocumentosTab;
